    ...
    def submit(self, run_args={}, **set_args):
        ...
        Args:
            run_args (dict): Keyword arguments to be passed to
                :meth:`~.pytb.parallel.MPRunner.run`.
        **set_args: Keyword arguments passed to
            :meth:`~.pytb.parallel.MPRunner.set_`
            before calling :meth:`~.pytb.parallel.MPRunner.run`.
        """
...
class SlurmManager(object):
    ...
    def __init__(self, runner: MPRunner, directory=None, modules=["python", "gcc"],
        ...
        #: The :class:`~.pytb.parallel.MPRunner` object.
        self.runner = runner
    ...
    def batch_script(self):
        ...
        from pytb.parallel import slurm_options
